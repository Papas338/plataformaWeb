...
/*ListaLideresTemp lee la lista de los lideres */
func ListaLideresTemp(w http.ResponseWriter, r *http.Request) {
	...
	var result []*models.LiderGeneral
	var status bool

	result, status = bd.VisualizarLiderGeneral(pag, search)
	if status == false {
